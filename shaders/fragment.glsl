...
uniform sampler2D uImage; // Uniform variable to hold the texture
varying vec2 vUv; // Varying variable to receive UV coordinates from vertex shader
...
void main() {
    ...
    gl_FragColor = tex;// Sample the texture at the UV coordinates
}
